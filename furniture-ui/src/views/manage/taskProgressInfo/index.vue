  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="taskProgressInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="需求" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="demandId" />
        <el-table-column label="任务" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="taskId" />
        <el-table-column label="进度描述" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="progress" />
        ...
        <el-table-column label="装修人员" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="userId" />
        <el-table-column label="部门" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="deptId" />
...
<script>
import { listTaskProgressInfo, getTaskProgressInfo, delTaskProgressInfo, addTaskProgressInfo, updateTaskProgressInfo } from "@/api/manage/taskProgressInfo";
