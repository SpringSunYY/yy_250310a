<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="clientInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客户名称" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible"
                       prop="clientName"
      />
...
<script>
import { addClientInfo, delClientInfo, getClientInfo, listClientInfo, updateClientInfo } from '@/api/manage/clientInfo'
