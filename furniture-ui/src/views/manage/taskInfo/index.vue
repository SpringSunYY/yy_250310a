  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="taskInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="任务名称" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="taskName" />
        <el-table-column label="装修面积" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="furnishSpace" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="装修面积" prop="furnishSpace">
          <el-input v-model="form.furnishSpace" placeholder="请输入装修面积" />
        </el-form-item>
        <el-form-item label="任务状态" prop="taskStatus">
