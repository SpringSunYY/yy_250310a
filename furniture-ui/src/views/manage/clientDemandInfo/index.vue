  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="clientDemandInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        <el-table-column label="客户" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="clientId" />
        <el-table-column label="需求名称" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="demandName" />
        <el-table-column label="房屋面积" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="floorSpace" />
        <el-table-column label="地址" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible" prop="address" />
        <el-table-column label="房屋朝向" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="buildOrientation" />
        <el-table-column label="装修风格" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible" prop="furnishStyle" />
        <el-table-column label="总预算" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="totalBudget" />
        ...
        <el-table-column label="销售员" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible" prop="userId" />
        <el-table-column label="部门" :show-overflow-tooltip="true" align="center" v-if="columns[12].visible" prop="deptId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="房屋面积" prop="floorSpace">
          <el-input v-model="form.floorSpace" placeholder="请输入房屋面积" />
        </el-form-item>
...
<script>
import { listClientDemandInfo, getClientDemandInfo, delClientDemandInfo, addClientDemandInfo, updateClientDemandInfo } from "@/api/manage/clientDemandInfo";
